...
export default function ExperienceItem({title, srcLogo, position, time, description}: experienceItemProps) {
  return (
    <div className="w-full flex flex-col items-center border-[0.0625rem] border-solid border-gray-500 rounded-lg shadow-md shadow-gray-500 outline-0 md:flex-1 lg:min-h-[30.375rem] md:min-h-[27.625rem] min-h-[25.625rem]">
